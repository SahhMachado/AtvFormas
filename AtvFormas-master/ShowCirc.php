...
<body>
    ...
    <p> Ordernar e pesquisar por:</p><br>
        <form method="post" action="">
            ...
            <input type="radio" name="cnst" value="2" <?php if ($cnst == "2") echo "checked" ?>> raio<br>
            <input type="radio" name="cnst" value="3" <?php if ($cnst == "3") echo "checked" ?>> Cor<br>
            <input type="radio" name="cnst" value="4" <?php if ($cnst == "4") echo "checked" ?>> ID Tabuleiro<br>
    <br><br>
    </form>
<table class="tab">
            <tr>
    ...
    <tr>
    <?php
        $lista = Circulo::listar($cnst, $procurar);
    ...
    ?>
            ...
            <td><?php echo $linha['circ_idtab'];?></td>   
            
            <td><a href='listarCirc.php?id=<?php echo $linha['id'];?>&raio=<?php echo $linha['raio'];?>&cor=<?php echo $cor;?>&circ_idtab=<?php echo $linha['circ_idtab'];?>'><img src='img/listar.svg'></a></td>
            <td><a href='cadCirc.php?acao=editar&id=<?php echo $linha['id'];?>'><img src='img/edit.svg'></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('acaoCirc.php?acao=excluir&id={$linha['id']}')>
