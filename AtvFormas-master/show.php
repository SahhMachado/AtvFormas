...
<table class="tab">
    ...
    ?>
            ...
            <td><a href='listar.php?id=<?php echo $linha['id'];?>&lado=<?php echo $linha['lado'];?>&cor=<?php echo $cor;?>&quad_idTabuleiro=<?php echo $linha['quad_idTabuleiro'];?>'><img src='img/listar.svg'></a></td>
