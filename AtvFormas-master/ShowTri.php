...
<table class="tab">
    ...
    <tr>
    <?php
        $lista = Triangulo::listar($cnst, $procurar);
    ...
    ?>
            ...
            <td><?php echo $linha['tri_idtabuleiro'];?></td>
            
            <td><a href='listarTri.php?id=<?php echo $linha['id'];?>&base=<?php echo $linha['base'];?>&lado1=<?php echo $linha['lado1'];?>&lado2=<?php echo $linha['lado2'];?>&cor=<?php echo $cor;?>&tri_idtabuleiro=<?php echo $linha['tri_idtabuleiro'];?>'>
            <img src='img/listar.svg'></a></td>
            <td><a href='cadTri.php?acao=editar&id=<?php echo $linha['id'];?>'><img src='img/edit.svg'></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('acaoTri.php?acao=excluir&id={$linha['id']}')>
